        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading1">
                <div class="btn-group"  style="margin-left:30px; margin-top:10px;"> 
                    <a class="btn btn-primary" href="<?php echo base_url("client/wholesaler/wholesaler_list") ?>"> <i class="fa fa-list"></i>  <?php echo "Wholesaler List" ?> </a> 
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-xs-12">
                        <?php echo form_open_multipart('client/wholesaler/wholesaler_form/'.$wholesaler->id,'class="form-inner"') ?>

                            <?php echo form_hidden('id', $wholesaler->id) ?>
                            <div class="col-xs-4">
                                <label class="form-label" for="product_dosage_form">Company Name</label>
                                <i class="text-danger">*</i>
                                <select class="form-control" name="wholesaler_company_id" id="wholesaler_company_id">
									<option value="0">Please Select</option>
                                <? $crows = $this->db->query("select * from companies where comp_status!=1 order by comp_name asc")->result();
								foreach($crows as $crow):
								?>
								<option value="<?php echo $crow->comp_id;?>" <? if($wholesaler->wholesaler_company_id==$crow->comp_id) echo "selected";?>><?php echo $crow->comp_name;?></option>
								<? endforeach;?>
                                </select>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_name">Wholesaler Name</label>
                                <i class="text-danger">*</i>
                                <div class="controls">
                                    <input type="text" name="wholesaler_name" required="required" class="form-control" id="wholesaler_name" value="<?php echo $wholesaler->wholesaler_name; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_ID">Wholesaler ID</label>
                                <i class="text-danger">*</i>
                                <div class="controls">
                                    <input type="text" name="wholesaler_ID" required="required" class="form-control" id="wholesaler_ID" value="<?php echo $wholesaler->wholesaler_ID; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_working_hours">Working Hours</label>
                                <span class="desc">*</span>
                                <select class="form-control" name="wholesaler_working_hours" id="wholesaler_working_hours">
                                    <option></option>
								<? $crows = $this->db->query("select * from working_hours order by wh_name asc")->result();
								foreach($crows as $crow):
								?>
								<option value="<?php echo $crow->wh_id;?>" <? if($wholesaler->wholesaler_working_hours==$crow->wh_id) echo "selected";?>><?php echo $crow->wh_name;?></option>
								<? endforeach;?>
                                </select>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_email_address">Email Address</label>
                                <i class="text-danger">*</i>
                                <div class="controls">
                                    <input type="text" name="wholesaler_email_address" required="required" class="form-control" id="wholesaler_email_address" value="<?php echo $wholesaler->wholesaler_email_address; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_class">Class</label>
                                <span class="desc"></span>
                                <select class="form-control" name="wholesaler_class" id="wholesaler_class">
                                    <option></option>
								<? $crows = $this->db->query("select * from classes order by cl_name asc")->result();
								foreach($crows as $crow):
								?>
								<option value="<?php echo $crow->cl_id;?>" <? if($wholesaler->wholesaler_class==$crow->cl_id) echo "selected";?>><?php echo $crow->cl_name;?></option>
								<? endforeach;?>
                                </select>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_segment">Segment</label>
                                <span class="desc"></span>
                                <select class="form-control" name="wholesaler_segment" id="wholesaler_segment">
                                    <option></option>
								<? $crows = $this->db->query("select * from segment order by seg_name asc")->result();
								foreach($crows as $crow):
								?>
								<option value="<?php echo $crow->seg_id;?>" <? if($wholesaler->wholesaler_segment==$crow->seg_id) echo "selected";?>><?php echo $crow->seg_name;?></option>
								<? endforeach;?>
                                </select>
                            </div>
                             <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_products">Associated Products</label>
                            ...
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_contact_person">Contact Person</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_contact_person" class="form-control" id="wholesaler_contact_person" value="<?php echo $wholesaler->wholesaler_contact_person; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_primary_contact">Primary Contact Number</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_primary_contact" class="form-control" id="wholesaler_primary_contact" value="<?php echo $wholesaler->wholesaler_primary_contact; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_secondary_contact">Secondary Contact Number</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_secondary_contact" class="form-control" id="wholesaler_secondary_contact" value="<?php echo $wholesaler->wholesaler_secondary_contact; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_address">Address</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_address" class="form-control" id="wholesaler_address" value="<?php echo $wholesaler->wholesaler_address; ?>">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_city">City</label>
                                <span class="desc"></span>
                                <select name="wholesaler_city" class="form-control" id="wholesaler_city" >
                                <option></option>
								<?php $crows = $this->db->query("select * from cities order by city_name asc")->result();
								foreach($crows as $crow):
								?>
								<option value="<?php echo $crow->city_id;?>" <?php if($wholesaler->wholesaler_city==$crow->city_id) echo "selected";?>><?php echo $crow->city_name;?></option>
								<?php endforeach;?>
								</select>
                            </div>
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_longitude">Longitude</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_longitude" class="form-control" id="wholesaler_longitude" value="<?php echo $wholesaler->wholesaler_longitude; ?>">
                                </div>
                            </div>                            
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_latitude">Latitude</label>
                                <span class="desc"></span>
                                <div class="controls">
                                    <input type="text" name="wholesaler_latitude" class="form-control" id="wholesaler_latitude" value="<?php echo $wholesaler->wholesaler_latitude; ?>">
                                </div>
                            </div>
                              
                            <div class="col-xs-4">
                                <label class="form-label" for="wholesaler_remarks">Remarks</label>
                                <span class="desc"></span>
                                <div class="controls">                                    
                                    <textarea name="wholesaler_remarks" class="form-control tinymce"  placeholder="Description"  rows="3"><?php echo $wholesaler->wholesaler_remarks ?></textarea>
                                </div>
                            </div>
...
/////////////////////////////rizwan//////////////
	$('#wholesaler_company_id').on('change',function(){
	var company_id = $('#wholesaler_company_id').val();
	$.ajax({ 
