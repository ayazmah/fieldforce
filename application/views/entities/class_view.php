        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading1">
                <div class="btn-group" style="margin-left:30px; margin-top:10px;">
                    <a class="btn btn-success" href="<?php echo base_url("entities/classes/class_form") ?>"> <i class="fa "></i>  <?php echo "Add New" ?> </a>  
                </div>
            </div>

            <div class="panel-body">
                <?php echo form_open('entities/classes/class_list') ?>
                <div class="row">
                    <div class="col-12 col-md-12 " align="center">
                        <div class="col-4 col-md-4">
                            <p><input id="cl_name" type="text" style="min-width: 110px;" class="form-control" name="cl_name"
                        ...
                        <?php if (!empty($classes)) { ?>
                            ...
                            <?php foreach ($classes as $cl) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">                                         
                                        <a href="<?php echo base_url("entities/classes/class_form/$cl->cl_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>    
                                        <a  data-target="#cmpltadminModal-2" id="<?php echo $cl->cl_id; ?>" data-toggle="modal" href="javascript:void()" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>                                     
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
...
$(document).ready(function() {
  ...
  $('#cmpltadminModal-2').on('show.bs.modal', function(e) {
	...
	//alert(id);
	window.location = '<?php echo base_url('entities/classes/delete/')?>'+id;	
    });	  
