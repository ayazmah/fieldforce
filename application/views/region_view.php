...
<div class="col-xs-12">
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title"><?=$region_caption?></h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong><?=$region_caption .' List';?></strong>
                                </li>
                            </ol>
                        </div>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <table id="example" class="display table table-hover table-condensed">
												...
												<?php if(!empty($rows)) {
													  ...
													  $crow = $this->db->query('select us_name from users where us_id ='.$row->re_us_id)->row();	  
													?>	
                                                    <tr>
                                                        <td><?php echo $row->re_name; ?></td>
                                                        <td><?php echo $crow->us_name; ?></td>
                                                        <td><?php echo $row->re_status?'Active':'In Active'; ?></td>
                                                        <td><?php echo $row->re_created_on; ?></td>
                                                        <td><a href="<?php echo base_url('region/add/'.$row->re_id) ?>" style="color: inherit;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> / <a class="del" style="color: inherit;" data-target="#cmpltadminModal-2" id="<?php echo $row->re_id; ?>" data-toggle="modal" href="javascript:void()"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
$(document).ready(function() {
  ...
  $('#cmpltadminModal-2').on('show.bs.modal', function(e) {
	...
	//alert(id);
	window.location = '<?php echo base_url('region/delete/')?>'+id;	
    });	  
