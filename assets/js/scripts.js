...
jQuery(function($) {
    ...
    CRYPTOKIT_SETTINGS.ios7Switchery = function() {
        ...
        if ($(".js-switch").length > 0) {
            ...
            var count = 0;
            var colors = ['#f44336', '#e91e63', '#9c27b0', '#673ab7', '#e77512', '#2196f3', '#03a9f4', '#00bcd4', '#009688', '#4d9cf8', '#8bc34a', '#cddc39', '#ffeb3b', '#ffc107', '#ff9800', '#ff5722', '#795548', '#9e9e9e', '#607d8b', '#000000'];
